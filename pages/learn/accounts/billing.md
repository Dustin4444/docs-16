...
* **Inactive**: The device has been either [deactivated](../manage/actions.md#deactivate-device) or [preregistered](https://github.com/balena-io/docs/blob/main/pages/external-docs/masterclasses/advanced-cli.md) but hasn't connected to the balenaCloud API yet.
