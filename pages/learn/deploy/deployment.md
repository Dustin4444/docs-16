...
To get started with the balena CLI, check out our [balena CLI masterclass](https://github.com/balena-io/docs/blob/main/pages/external-docs/masterclasses/cli-masterclass.md)
