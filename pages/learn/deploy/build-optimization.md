...
{% hint style="info" %}
For information on using multi-stage builds to reduce image sizes, see the [services masterclass](https://github.com/balena-io/docs/blob/main/pages/external-docs/masterclasses/services-masterclass.md#id-6.-multi-stage-builds).
{% endhint %}
