...
{% hint style="info" %}
For additional information on working with Dockerfiles with balena see the [services masterclass](https://github.com/balena-io/docs/blob/main/pages/external-docs/masterclasses/services-masterclass.md).
{% endhint %}
...
The balena Supervisor requires that the directory `/tmp/balena` in containers be available for inter-container communication via [update locks](https://github.com/balena-io/docs/blob/main/pages/external-docs/update-locking.md). Therefore, scripts should not attempt to remove this directory on startup.
